...
# 36 "teste_b4.c"
asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); asm("\tdb\t" "0x00" "," "0x11" "," "0x22" "," "0x33" "," "0x44" "," "0x55" "," "0x66" "," "0x77");
asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); asm("\tdb\t" "0x88" "," "0x99" "," "0xAA" "," "0xBB" "," "0xCC" "," "0xDD" "," "0xEE" "," "0xFF");
...
measured_temperature = (adc_amostra(2) * 10) / 2;
